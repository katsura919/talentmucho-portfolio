    ...
    >
      <div className="container relative z-10">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_0.95fr]">
          <div>
            <span className="mb-4 block text-sm font-semibold uppercase tracking-wider text-[var(--primary)]">
              Build Scale With The Right Team
            </span>
            <h1 className="mb-6 text-4xl font-light leading-tight text-[var(--primary)] md:text-5xl lg:text-6xl">
